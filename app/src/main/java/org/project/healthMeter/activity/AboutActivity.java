...
public class AboutActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(getString(R.string.preferences_about_healthMeter));
    }
    ...
    public static class MyPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(final Bundle savedInstanceState) {
           ...
           // final Preference licencesPref = (Preference) findPreference("preference_licences");
            ...
            final Preference contactUsPref = (Preference) findPreference("preference_contactUs");
            ...
            contactUsPref.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                @Override
                public boolean onPreferenceClick(Preference preference) {
                    Intent intent = new Intent(getActivity(), LicenceActivity.class);
                    Bundle bundle= new Bundle();
                    bundle.putString("key", "contactUs");
                    intent.putExtras(bundle);
                    startActivity(intent);
                    return false;
                }
